...
func (s *state5) BalancesChanged(otherState State) (bool, error) {
	otherState2, ok := otherState.(*state5)
	if !ok {
...
func (s *dealProposals5) Get(dealID abi.DealID) (*DealProposal, bool, error) {
	var proposal2 market5.DealProposal
