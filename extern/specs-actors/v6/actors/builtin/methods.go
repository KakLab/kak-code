...
var MethodsPower = struct {
	...
	UpdatePosTotal           abi.MethodNum
	CurrentTotalPosPower     abi.MethodNum
...
var MethodsMiner = struct {
	...
	AddPos                   abi.MethodNum
	WithDrawPos              abi.MethodNum
	KPledge                  abi.MethodNum
