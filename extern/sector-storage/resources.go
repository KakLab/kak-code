...
var ResourceTable = map[sealtasks.TaskType]map[abi.RegisteredSealProof]Resources{
	...
	sealtasks.TTCommit2: {
		...
		abi.RegisteredSealProof_StackedDrg8GiBV1: Resources{
			MaxMemory: 50 << 30, // TODO: ~30G of this should really be BaseMaxMemory
			MinMemory: 8 << 30,
...
func init() {
	...
	for _, m := range ResourceTable {
		...
		m[abi.RegisteredSealProof_StackedDrg8GiBV1_1] = m[abi.RegisteredSealProof_StackedDrg8GiBV1]
