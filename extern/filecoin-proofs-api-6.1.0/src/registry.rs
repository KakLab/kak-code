...
impl RegisteredSealProof {
    ...
    pub fn version(self) -> ApiVersion {
        ...
        match self {
            ...
            | StackedDrg8GiBV1_1 | StackedDrg32GiBV1_1 | StackedDrg64GiBV1_1 => ApiVersion::V1_1_0,
        }
    }
    ...
    pub fn sector_size(self) -> SectorSize {
        ...
        let size = match self {
            ...
            StackedDrg8GiBV1 | StackedDrg8GiBV1_1 => constants::SECTOR_SIZE_8_GIB,
    ...
    pub fn partitions(self) -> u8 {
        ...
        match self {
            ...
            StackedDrg512MiBV1 | StackedDrg512MiBV1_1 => *constants::POREP_PARTITIONS
                ...
                .expect("invalid sector size"),
            StackedDrg8GiBV1 | StackedDrg8GiBV1_1 => *constants::POREP_PARTITIONS
                .read()
                .expect("porep partitions read error")
                .get(&constants::SECTOR_SIZE_8_GIB)
                .expect("invalid sector size"),
    ...
    pub fn single_partition_proof_len(self) -> usize {
        ...
        match self {
            ...
            | StackedDrg512MiBV1_1 | StackedDrg8GiBV1_1 | StackedDrg32GiBV1_1 | StackedDrg64GiBV1_1 => {
    ...
    pub fn into_winning_post(self) -> RegisteredPoStProof {
        ...
        match self {
            ...
            StackedDrg8GiBV1 | StackedDrg8GiBV1_1 => StackedDrgWinning8GiBV1,
    ...
    pub fn into_window_post(self) -> RegisteredPoStProof {
        ...
        match self {
            ...
            StackedDrg8GiBV1 | StackedDrg8GiBV1_1 => StackedDrgWindow8GiBV1,
...
impl RegisteredPoStProof {
    ...
    pub fn sector_size(self) -> SectorSize {
        ...
        let size = match self {
            ...
            StackedDrgWinning8GiBV1 | StackedDrgWindow8GiBV1 => constants::SECTOR_SIZE_8_GIB,
...
mod tests {
    ...
    const REGISTERED_SEAL_PROOFS: [RegisteredSealProof; 12] = [
        ...
        RegisteredSealProof::StackedDrg8GiBV1_1,
