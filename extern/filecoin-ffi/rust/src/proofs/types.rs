    ...
    fn from(other: RegisteredSealProof) -> Self {
        match other {
            ...
            RegisteredSealProof::StackedDrg8GiBV1_1 => {
                fil_RegisteredSealProof::StackedDrg8GiBV1_1
            }
...
impl From<RegisteredPoStProof> for fil_RegisteredPoStProof {
    fn from(other: RegisteredPoStProof) -> Self {
        ...
        match other {
            ...
            StackedDrgWinning8GiBV1 => fil_RegisteredPoStProof::StackedDrgWinning8GiBV1,
            ...
            StackedDrgWindow8GiBV1 => fil_RegisteredPoStProof::StackedDrgWindow8GiBV1,
...
impl From<fil_RegisteredPoStProof> for RegisteredPoStProof {
    fn from(other: fil_RegisteredPoStProof) -> Self {
        ...
        match other {
            ...
            fil_RegisteredPoStProof::StackedDrgWinning8GiBV1 => StackedDrgWinning8GiBV1,
            ...
            fil_RegisteredPoStProof::StackedDrgWindow8GiBV1 => StackedDrgWindow8GiBV1,
