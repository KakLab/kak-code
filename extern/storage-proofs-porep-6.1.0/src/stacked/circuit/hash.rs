...
use filecoin_hashers::{POSEIDON_CONSTANTS_11, POSEIDON_CONSTANTS_4, POSEIDON_CONSTANTS_2};
use generic_array::typenum::{U11, U4, U2};
    ...
    CS: ConstraintSystem<Bls12>,
{
    match column.len() {
        ...
        4 => poseidon_hash::<CS, Bls12, U4>(cs, column.to_vec(), &*POSEIDON_CONSTANTS_4),
