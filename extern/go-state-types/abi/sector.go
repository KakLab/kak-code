...
const (
	...
	RegisteredSealProof_StackedDrg2KiBV1_1   = RegisteredSealProof(6)
	RegisteredSealProof_StackedDrg8MiBV1_1   = RegisteredSealProof(7)
	RegisteredSealProof_StackedDrg512MiBV1_1 = RegisteredSealProof(8)
	RegisteredSealProof_StackedDrg8GiBV1_1  = RegisteredSealProof(9)
...
var SealProofInfos = map[RegisteredSealProof]*SealProofInfo{
	...
	RegisteredSealProof_StackedDrg8GiBV1: {
		// The proof sizes are 192 * the number of "porep" partitions(constants.rs).
		ProofSize:        1920,
		SectorSize:       ss8GiB,
	...
	RegisteredSealProof_StackedDrg8GiBV1_1: {
		// The proof sizes are 192 * the number of "porep" partitions(constants.rs).
		ProofSize:        1920,
		SectorSize:       ss8GiB,
		WinningPoStProof: RegisteredPoStProof_StackedDrgWinning8GiBV1,
...
var PoStProofInfos = map[RegisteredPoStProof]*PoStProofInfo{
	...
	RegisteredPoStProof_StackedDrgWinning8GiBV1: {
		SectorSize: ss8GiB,
		ProofSize:  192,
	},
	...
	RegisteredPoStProof_StackedDrgWindow8GiBV1: {
		SectorSize: ss8GiB,
		ProofSize:  192,
	},
