...
lazy_static! {
    ...
    pub static ref POREP_PARTITIONS: RwLock<HashMap<u64, u8>> = RwLock::new(
        [
            ...
            (SECTOR_SIZE_1_GIB, 1),
	    //go-state-types/abi/sector.go+192 ProofSize = 192*POREP_PARTITIONS
...
pub type SectorShape8GiB = SectorShapeTop2;
...
pub fn is_sector_shape_top2(sector_size: u64) -> bool {
    match sector_size {
        SECTOR_SIZE_32_KIB | SECTOR_SIZE_8_GIB | SECTOR_SIZE_64_GIB => true,
        _ => false,
    }
}
