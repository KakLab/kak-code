...
lotus wallet import --as-default ~/.genesis-sectors/pre-seal-k01000.key
lotus-miner init --genesis-miner --actor=k01000 --sector-size=2KiB --pre-sealed-sectors=~/.genesis-sectors --pre-sealed-metadata=~/.genesis-sectors/pre-seal-k01000.json --nosync
EOF
...
tmux send-keys -t $session:$wdaemon "lotus-seed genesis add-miner devnet.json ~/.genesis-sectors/pre-seal-k01000.json" C-m
