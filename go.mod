...
replace github.com/filecoin-project/specs-actors => ./extern/specs-actors/v1

replace github.com/filecoin-project/specs-actors/v2 => ./extern/specs-actors/v2

replace github.com/filecoin-project/specs-actors/v3 => ./extern/specs-actors/v3
